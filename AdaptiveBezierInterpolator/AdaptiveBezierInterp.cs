    ...
    public class AdaptiveBezierInterp : AsyncPositionedPipelineElement<IDeviceReport>
    {
        ...
        protected override void UpdateState()
        {
            ...
            if (State is ITabletReport report && PenIsInRange())
            {
                ...
                res = Vector3.Lerp(res, controlPointNext, (float)Math.Pow(Math.Pow(0.5, 2), Math.Pow(2, -1 * accel / vDiv)));
        ...
        protected override void ConsumeState()
        {
            ...
            if (State is ITabletReport report)
            {
                ...
                target = Vector3.Lerp(controlPoint, controlPointNext, (float)Math.Pow(0.5, Math.Pow(2, -1 * Math.Max(accel + velocity / (vDiv / 4), 0))));
